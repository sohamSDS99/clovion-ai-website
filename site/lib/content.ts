...
export const docsSections = [
  {
    ...
    items: [
      { label: 'Quickstart: your first visibility score', href: '/docs/quickstart' },
      { label: 'Connect your domain', href: '/docs/connect-domain' },
      { label: 'Pick the right competitors', href: '/docs/picking-competitors' },
      { label: 'Reading the score', href: '/docs/reading-the-score' }
    ]
  },
  {
    title: 'AI Visibility Tracking',
    items: [
      { label: 'How tracking works', href: '/docs/how-tracking-works' },
      { label: 'Prompt selection', href: '/docs/prompts' },
      { label: 'Sentiment scoring methodology', href: '/docs/sentiment' },
      { label: 'Share of voice math', href: '/docs/share-of-voice' },
      { label: 'Per-engine specifics', href: '/docs/per-engine' }
    ]
  },
  {
    title: 'GEO Improvement Suggestions',
    items: [
      { label: 'Fix prioritization explained', href: '/docs/fix-prioritization' },
      { label: 'Shipping a schema patch', href: '/docs/schema-patches' },
      { label: 'Content gap workflow', href: '/docs/content-gaps' },
      { label: 'Citation path recommendations', href: '/docs/citation-paths' },
      { label: 'Before-and-after tracking', href: '/docs/before-after' }
    ]
  },
  {
    title: 'Integrations',
    items: [
      { label: 'GA4 and Search Console', href: '/docs/ga4-gsc' },
      { label: 'CMS publishing connectors', href: '/docs/cms' },
      { label: 'Server log-drain (Vercel, Cloudflare, etc.)', href: '/docs/log-drain' },
      { label: 'CRM and warehouse sync', href: '/docs/crm-warehouse' },
      { label: 'Slack, Notion, Drive', href: '/docs/comms-tools' }
    ]
  },
  {
    title: 'API & MCP',
    items: [
      ...
      { label: 'Authentication and rate limits', href: '/docs/api-auth' },
      { label: 'Webhooks', href: '/docs/webhooks' },
      { label: 'MCP server setup', href: '/docs/mcp' },
      { label: 'SDKs (TypeScript, Python)', href: '/docs/sdks' }
    ]
  },
  {
    title: 'Security & compliance',
    items: [
      { label: 'Trust overview', href: '/docs/trust' },
      { label: 'SOC 2, ISO, GDPR, HIPAA', href: '/docs/compliance' },
      { label: 'Data residency', href: '/docs/data-residency' },
      { label: 'SSO and RBAC', href: '/docs/sso-rbac' },
