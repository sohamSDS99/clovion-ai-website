...
const themeBootstrap = `(function(){try{var p=location.pathname;var pre=['/news','/webinars','/faq','/compare','/alternatives','/docs','/legal','/tools'];var darkPre=pre.some(function(x){return p===x||p.indexOf(x+'/')===0;});if((p==='/free-ai-visibility-score'||p==='/customers'||p==='/about'||p==='/changelog'||darkPre)&&p!=='/compare/clovion-vs-peec-ai'&&p!=='/compare/clovion-vs-otterly'&&p!=='/compare/clovion-vs-searchable')document.documentElement.classList.add('clv-dark');}catch(_){}})();`
