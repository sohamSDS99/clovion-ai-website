...
const themeBootstrap = `(function(){try{var p=location.pathname;if(p==='/'||p==='/features/ai-visibility-tracking'||p==='/features/geo-improvement-suggestions'||p==='/features/sentiment-analysis'||p==='/features/fanout-query'||p==='/features/ai-crawlability')document.documentElement.classList.add('clv-dark');}catch(_){}})();`
