...
const themeBootstrap = `(function(){try{var p=location.pathname;var pre=['/news','/webinars','/faq','/compare','/alternatives','/docs','/legal'];var darkPre=pre.some(function(x){return p===x||p.indexOf(x+'/')===0;});if((p==='/customers'||p==='/about'||p==='/changelog'||darkPre)&&p!=='/compare/clovion-vs-peec-ai'&&p!=='/compare/clovion-vs-otterly'&&p!=='/compare/clovion-vs-searchable'&&p!=='/compare/clovion-vs-profound'&&p!=='/legal/privacy'&&p!=='/legal/terms')document.documentElement.classList.add('clv-dark');}catch(_){}})();`
