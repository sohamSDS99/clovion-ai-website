...
const themeBootstrap = `(function(){try{var p=location.pathname;var pre=['/blog','/news','/webinars','/resources','/faq','/compare','/alternatives','/docs','/legal','/tools'];var darkPre=pre.some(function(x){return p===x||p.indexOf(x+'/')===0;});if((p==='/features/ai-visibility-tracking'||p==='/features/geo-improvement-suggestions'||p==='/features/sentiment-analysis'||p==='/features/fanout-query'||p==='/features/ai-crawlability'||p==='/free-ai-visibility-score'||p==='/customers'||p==='/about'||p==='/changelog'||p==='/blog'||p==='/blog/category/geo'||p==='/blog/category/ai-search'||p==='/blog/category/seo'||darkPre)&&p!=='/compare/clovion-vs-peec-ai'&&p!=='/compare/clovion-vs-otterly'&&p!=='/compare/clovion-vs-searchable')document.documentElement.classList.add('clv-dark');}catch(_){}})();`
