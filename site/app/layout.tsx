...
const themeBootstrap = `(function(){try{var p=location.pathname;if(p==='/'||p==='/features/ai-visibility-tracking'||p==='/features/geo-improvement-suggestions'||p==='/features/sentiment-analysis'||p==='/features/fanout-query'||p==='/features/ai-crawlability'||p==='/pricing'||p==='/affiliate'||p==='/free-ai-visibility-score'||p==='/customers'||p==='/blog'||p==='/blog/category/geo'||p==='/blog/category/ai-search'||p==='/blog/category/seo')document.documentElement.classList.add('clv-dark');}catch(_){}})();`
